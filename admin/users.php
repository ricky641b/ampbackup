...
switch ($_REQUEST['action']) {
    ...
    break;
    case 'show_upload_news':
        $client      = new User($_REQUEST['user_id']);
        require_once AmpConfig::get('prefix') . UI::find_template('show_news_module.php');
    case 'upload_news':
    	if(isset($_POST["hiddenfield"]))
    	{
            ...
            $original_link = $_POST["original_link"];
   			$query = "INSERT INTO news(headline,story,original_link,timestamp)VALUES('$headline', '$story', '$original_link', NOW())";
   			$result = @mysqli_query($db_connect,$query);
   			if($result){
   				@mysqli_close($db_connect);
   				echo('Success!<br><a href="'.AmpConfig::get('web_path') . '/admin/users.php?action=show_upload_news">Click here</a> to add more news.<br><br><a href="'.AmpConfig::get('web_path') . '/index.php">Click here</a> to return to the main page.');
   			}	
    	}
   	break;
    default:
